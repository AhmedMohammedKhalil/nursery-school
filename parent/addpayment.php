        ...
        <div class="container">
          ...
          <form action="<?php echo $cont."ParentController.php?method=storePayment"?>" method="POST" class="form">
            <div style="display: flex;justify-content:center;flex-direction:column">
                <input type="hidden" name="kid_id" value="<?php echo $_SESSION['kid_id'] ?>" >

                <div>
                    <label class="label" for="description">Description</label>
                    <textarea name="description" title="Enter description" id="description" rows="6" placeholder="Enter description" required><?php if(isset($_SESSION['errors'])) echo $description?></textarea>
                </div>
